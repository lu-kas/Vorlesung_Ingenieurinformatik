...
\begin{document}
    ...
    \begin{tikzpicture}[scale=3]
        ...
        \def\yshift{-0.05}
        \draw[line width=1mm,decorate,decoration={brace,amplitude=22pt,mirror},yshift=0pt] (0,\yshift) -- (8,\yshift) node [black,midway,yshift=-0.8cm,below] {Bin\"are Darstellung der ganzen Zahl};
