...
\node [root concept] {Informatik} % root
	  child [T1] { node {Angewandte Informatik} 
	  	child { node {Numerik} } 
	  	child { node {Wissenschaftliches Rechnen} } 
	  	child { node {Spieltheorie} } 
	  	child { node {Quanteninformatik} } 
	  }
	  child [T2] { node {Technische Informatik} 
	  	child { node {Rechnerarchitektur} } 
	  	child { node {Automatisierung} } 
	  	child { node {Eingebettete Systeme} } 
	  	child { node {Regelungstechnik} }
	  }
	  child [T3] { node {Praktische Informatik} 
	  	child { node {Programmiersprachen} } 
	  	child { node {Datenstrukturen} }
	  	child { node {Betriebssysteme} } 
	  	child { node {Datenbanken} } 	  	
	  }
      child [T4] { node {Theoretische Informatik}
        child { node {Lösbare Probleme} }
        child { node {Komplexitätstheorie} }
